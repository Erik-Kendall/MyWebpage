        ...
        <main className="about-me-page">
            ...
            <div className="aboutme-biography card green-section">
                ...
                <section>
                    <h3>Bio</h3>
                    <p>
                        🌿 I have dedicated my life to protecting and restoring the planet. Born and raised in Seattle,
                        I developed a deep appreciation for nature while hiking the Pacific Northwest’s lush forests.
                        After earning a degree in Environmental Science, I worked on sustainability initiatives,
                        urban reforestation projects, and clean energy advocacy. I now lead community-driven programs
                        that focus on conservation, waste reduction, and educating others about sustainable living.
                    </p>
                </section>
