...
const Home = ({ setSiteShakeOn }) => {
    ...
    const { colorblindMode, toggleColorblindMode } = useColorblind(); // Keep this for the toggle button
    ...
    return (
        <section
            className="content"
            style={{ // Keep animation styles here if they are only for Home page
                maxWidth: '1000px',
                margin: '1rem auto',
                padding: '1rem',
                ...
                // REMOVED inline colorblind styles:
                    ...
                    <div className="tab-pane fade show active">
                        ...
                        <button
                            ...
                            style={{
                                ...
                                padding: '0.5rem 1rem',
                                cursor: 'pointer',
                                // REMOVED inline colorblind styles for button:
